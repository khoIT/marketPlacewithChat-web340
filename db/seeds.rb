...
p2 = Product.create(name: 'Painting', category_id:1, user_id: 2, price: 33.05, view: 3, img_url:"https://media.getchute.com/m/UR5eufvpn/c/2500342/fit/450x300")
...
p4 = Product.create(name: 'White Tank Top', category_id:5, user_id: 2, price: 55.75, view: 5, img_url:"https://media.getchute.com/m/UR5eszuip/c/2500342/fit/450x300")
p5 = Product.create(name: 'Books of Life', category_id:3, user_id: 1, price: 105.05, view: 4, img_url:"https://media.getchute.com/m/UR5epmqog/c/2500342/fit/450x300")
...
p8 = Product.create(name: 'Speedo', category_id:9, user_id: 2, price: 44.99, view: 0, img_url:"https://media.getchute.com/m/UR5enulna/c/2500342/fit/450x300")
...
p16 = Product.create(name: 'Yellow Chairs', category_id:6, user_id: 1, price: 44.99, view: 10, img_url:"https://media.getchute.com/m/UR5edfoub/c/2500342/fit/450x300")
